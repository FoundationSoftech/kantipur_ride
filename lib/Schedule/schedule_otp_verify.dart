...
class ScheduleOtpVerify extends StatefulWidget {
  @override
  _ScheduleOtpVerifyState createState() => _ScheduleOtpVerifyState();
}

class _ScheduleOtpVerifyState extends State<ScheduleOtpVerify> {
  ...
  void _submitOTP() {
    ...
    if (otp.length == 6) {
      Get.off(() => RideScheduleScreen(), transition: Transition.rightToLeft);
    }else {
